...
#define  USB_CFG_VENDOR_ID       0x55, 0xba
 ...
 */
#define USB_CFG_VENDOR_NAME     'V', 'D'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'A', 'R', 'T', '-', 'H', 'I', 'D'
...
//#define USB_CFG_INTERFACE_PROTOCOL  0 // Mouse
#define USB_CFG_INTERFACE_PROTOCOL  2 // Combo: Keyboard + Mouse
/* See USB specification if you want to conform to an existing device class or
 * protocol. The following classes must be set at interface level:
 * HID class is 3, no subclass and protocol required (but may be useful!)
 * CDC class is 2, use subclass 2 and protocol 1 for ACM
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH   119
